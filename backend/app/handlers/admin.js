...
const TABLE_CONFIG = {
    ...
    locations: {
        ...
        select: 'l.id, t.slug AS tracker_slug, c.slug AS client_slug, l.longitude, l.latitude, l.timestamp, l.battery_voltage, l.fix_number, l.created_at, (EXTRACT(EPOCH FROM l.created_at) - EXTRACT(EPOCH FROM l.timestamp)) AS latency',
        columns: ['id', 'tracker_slug', 'client_slug', 'longitude', 'latitude', 'timestamp', 'battery_voltage', 'fix_number', 'created_at', 'latency'],
        sortMap: {
            ...
            latency: '(EXTRACT(EPOCH FROM l.created_at) - EXTRACT(EPOCH FROM l.timestamp))',
        },
